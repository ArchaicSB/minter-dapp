...
const welcome_p = 'The Archaic Shell Babies NFT Project is sustainability-focused, and dedicated to saving the Sea Turtles. We are partnering with Ocean Clean-up programs, Sea Turtle Conservation, and sustainable Products. The Archaic Shell Babies are here to take over the web, rid the world plastic every single day, and save a couple more Sea Turtles. Welcome To ASB. Lets Ride This Wave Together.';
const h1_presale_coming_soon = "NFT Drop Coming Soon!!";
const h1_presale_mint = "Pre-Sale Minting Open!!";
const h1_public_mint = "Public Minting Is Finally Open!!";
...
const p_public_mint = "No whitelist for this project. PUBLIC MINT IS OPEN! 🎉";
...
const button_public_mint = "Mint Your Archaic Shell Babies NFT";
